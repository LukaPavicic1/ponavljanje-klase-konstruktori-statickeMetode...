    ...
    class Food
    {
        ...
        internal class Program
        {
            static void Main(string[] args)
           {
            ...
            Console.WriteLine("Unesi udio proteina u postotcima: ");
            int protein = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine("Unesi udio ugljikohidrata u postotcima: ");
            int carbs = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine("Unesi udio masti u postotcima: ");
